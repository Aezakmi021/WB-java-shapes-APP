...
public class Rectangle extends SurfaceShape {
	...
	public String toString() {
		return "UpperLeftPoint=" + upperLeftPoint + "," + "widht=" + width + "," + "height=" + height + "," + "edge color:" + getColor() + "," + "inner color:" + getInnerColor();
	}

	public Rectangle clone() {
	    Point newUpperLeftPoint = new Point(this.upperLeftPoint.getX(), this.upperLeftPoint.getY());
	    Rectangle clone = new Rectangle(newUpperLeftPoint, this.width, this.height, this.isSelected(), this.getColor(), this.getInnerColor());
